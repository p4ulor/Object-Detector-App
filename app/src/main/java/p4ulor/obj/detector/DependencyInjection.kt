...
/**
 * Koin dependencies will be managed with annotations and processed with [KSP](https://kotlinlang.org/docs/ksp-quickstart.html#add-a-processor)
 ...
 */
@Module
@ComponentScan("p4ulor.obj.detector")
